...
|---|---|---|---|---|---|
| 0.1 Basic UAT sweep | IN_PROGRESS | P0 | `#core #uat` | Test toàn bộ Basic Pipelines 0-10 theo `TEST_PIPELINE.md` với ít nhất 2 account | Automated/headless flow đã pass; còn WebRTC media và Web Push trên thiết bị thật |
...
| 0.3 Privacy/search/notification UAT | IN_PROGRESS | P0 | `#privacy #notification #search` | Test A4.2, A6.1, 7.4, 7.6, 8.2, 8.6 | Search/jump/link preview/privacy persistence pass; còn avatar thật, Web Push và lỗi đếm badge cần chốt |
...
| 2.4 Message Evolution | READY_TO_TEST | P2 | `#wow #core` | Convert message thành task, poll, event, checklist item | Object mới giữ link tới message gốc và jump được |
