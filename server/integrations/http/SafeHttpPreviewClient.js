...
class SafeHttpPreviewClient {
  async fetchHtml(rawUrl, redirectCount = 0) {
    ...
    if ([301, 302, 303, 307, 308].includes(response.status)) {
      ...
      return this.fetchHtml(new URL(location, url).toString(), redirectCount + 1);
    }
...
export default SafeHttpPreviewClient;
